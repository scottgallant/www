  ...
  render() {
    ...
    <div className="wrapper">
      ...
      <div className="contact">
        ...
        <div className="line"></div>
        <div className="name">
          <a href="https://www.linkedin.com/in/rafaelcorrales/">
            Rafael Corrales
        ...
        <a href="https://www.linkedin.com/pulse/introducing-background-capital-rafael-corrales/">Background Capital Fund 1</a>
      </div>
      <style jsx>{`
        a {
